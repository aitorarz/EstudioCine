...
namespace Cine.Modelos
{
    class PeliHorror : IPelicula
    {
        ...
        public PeliHorror(string titulo, int duracion, DateTime fechaEstreno, int progresoPorcentual)
        {
            Directores = new List<IPersona>();
            Actores = new List<IPersona>();
            Titulo = titulo;
            GeneroPelicula = GeneroPelicula.Horror;
            Duracion = duracion;
