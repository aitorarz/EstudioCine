...
namespace Cine.Modelos
{
    class PeliComedia : IPelicula
    {
        ...
        public PeliComedia(string titulo, int duracion, DateTime fechaEstreno, int progresoPorcentual)
        {
            Directores = new List<IPersona>();
            Actores = new List<IPersona>();
            Titulo = titulo;
            GeneroPelicula = GeneroPelicula.Comedia;
            Duracion = duracion;
